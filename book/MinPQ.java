...
//        }
        //String item="Ivan-1200, Gene-1400,Mike-1000, Isabelle-1100, Marshall-1350, Lee-200, Moore-450";
        String item="Ivan 1200 - Mike 1000- lee 2000";
        StdOut.println("(" + pq.size() + " initially on pq)");
        if (item.contains("-")) pq.insert(item);
        else if (!pq.isEmpty()) StdOut.print(pq.delMin() + " ");
